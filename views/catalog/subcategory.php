<?php include( ROOT . '/views/layouts/header.php' );
    ...
    /** @var CatalogController $subcategoriesProducts */
        ...
        <div class="container">
            <div class="wrapper">
                                        ...
                                        foreach ($subcategories as $subcategory) : ?>
                                            <li class="accordeon-body__item">
                                                <a class="accordeon-body__link"
                                                   href="<?php echo $subcategory['sub_id']; ?>">
                ...
                <div class="wrapper__content">
                    ...
                    <ul class="view-grid">
                        <?php if (empty($subcategoriesProducts)) {
                          echo'  <div class="card__error">Вданной подкатегории пока нет товаров</div>';
                        } else {
                            foreach ($subcategoriesProducts as $product) : ?>
                            ...
                            <?php endforeach; ?>
                            <?php foreach ($subcategoriesProducts as $product) : ?>
                                <li class="card card__list" data-id="<?php echo $product['id']; ?>">
                                    ...
                                    <div class="card__content card__content--list">
                                        ...
                                        <div class="card__subtitle"><?php echo $product['description']; ?></div>
                                        <div class="card__price card__price--list">
