...
<div class="breadcrumbs content">
    <div class="container">
        <ul class="breadcrumbs__list">
            ...
            <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="list view.html"> list view /</a></li>
            <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="cart.html">cart</a></li>
        </ul>
    </div>
</div>
<main class="content">
                        ...
                        <div class="accordeon-body" data-accordeon-body="data-accordeon-body">
                            <form class="accordeon-body__form">
                                <div class="accordeon-body__block accordeon-body__block--marg"><input
                                            class="accordeon-body__radio" type="radio" name="color" id="blue"/><label
                                            for="blue"></label><input class="accordeon-body__radio" type="radio"
                                                                      name="color" id="yellow"/><label
                                            for="yellow"></label><input class="accordeon-body__radio" type="radio"
                                                                        name="color" id="green"/><label
                                            for="green"></label></div>
                                <div class="accordeon-body__block"><input class="accordeon-body__radio" type="radio"
                                            ...
                                            for="sky"></label><input class="accordeon-body__radio" type="radio"
                                                                     name="color" id="dark"/><label for="dark"></label>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="accordeon">
                        ...
                        <div class="accordeon-body" data-accordeon-body="data-accordeon-body">
                            <form class="accordeon-body__form">
                                ...
                                <div class="accordeon-body__block"><input class="accordeon-body__checkbox"
                                                                          type="checkbox" name="size" id="sizeL"/><label
                                            class="accordeon-body__label" for="sizeL">L</label><input
                                            class="accordeon-body__checkbox" type="checkbox" name="size"
                                            id="sizeXXL"/><label class="accordeon-body__label" for="sizeXXL">XXL</label><input
                                            class="accordeon-body__checkbox" type="checkbox" name="size"
                                            id="sizeM"/><label class="accordeon-body__label" for="sizeM">M</label></div>
                            </form>
                        </div>
                    </div>
                    <div class="accordeon">
		...
		C60.124,31.719,58.781,33.062,57.124,33.062z"/>
                            ...
                            <div class="top-filter__icon top-filter__icon--grid">
                                ...
                                <svg version="1.1" id="grid" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                     viewBox="0 0 341.333 341.333" style="enable-background:new 0 0 341.333 341.333;"
                                     xml:space="preserve">
										<g>
                                            <g>
                                                <g>
